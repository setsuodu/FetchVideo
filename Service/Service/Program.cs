...
using (var scope = app.Services.CreateScope())
{
    ...
    if (!db.LinkItems.Any())
    {
        var defaultLinks = new List<LinkItem>
        {
            ...
            // 可以继续添加更多默认链接
            new LinkItem { Name = "青清禾月",       Url = "https://live.bilibili.com/1786263208", Active = true },
            new LinkItem { Name = "秋茗ovo",        Url = "https://live.bilibili.com/1946284495", Active = true },
            new LinkItem { Name = "蔓柠er",         Url = "https://live.bilibili.com/1786565278", Active = true },
            new LinkItem { Name = "鲨鱼摆摆崽",     Url = "https://live.bilibili.com/1889475119", Active = true },
            new LinkItem { Name = "小栩小不点-",    Url = "https://live.bilibili.com/32270626", Active = true },
        }
    ;
